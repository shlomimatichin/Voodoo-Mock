...
#   define TSM_ASSERT_THROWS_NOTHING(m,e) _TSM_ASSERT_THROWS_NOTHING(__FILE__,__LINE__,m,e)
	...
	// TS_STACK
#	define TS_STACK( e ) \
	{ _TS_TRY { e; } _TS_LAST_CATCH( { TS_TRACE( "TS_STACK: From here" ); throw; } ) }
#	define TSM_STACK( m, e ) \
	{ _TS_TRY { e; } _TS_LAST_CATCH( { TS_TRACE( m ); TS_TRACE( "TS_STACK: From here" ); throw; } ) }
