...
os.mkdir( "/tmp/clang" )
os.chdir( "/tmp/clang" )
subprocess.check_call( "svn co http://llvm.org/svn/llvm-project/llvm/trunk llvm", shell = True )
checkoutClang = subprocess.Popen( "svn co http://llvm.org/svn/llvm-project/cfe/trunk clang", shell = True, cwd = "llvm/tools" )
subprocess.check_call( "svn co http://llvm.org/svn/llvm-project/compiler-rt/trunk compiler-rt", shell = True, cwd = "llvm/projects" )
